package com.sunlight001.encrypt.andios;
...
public class NEW {  
     ...
     // 向量  
     private final static String iv = "hxxykoa1" ;  
     // 加解密统一使用的编码方式  
	...
	public static class Base64 {  
     ...
     public static void main(String[] args) throws Exception{
    	 ...
    	 String encryptText = NEW.encode(username,key);
    	 System.out.println(encryptText+key);
    	 System.out.println(NEW.decode(encryptText,key));
     }
